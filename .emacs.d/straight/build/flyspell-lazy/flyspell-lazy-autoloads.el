;;; flyspell-lazy-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(let ((loads (get 'flyspell-lazy 'custom-loads))) (if (member '"flyspell-lazy" loads) nil (put 'flyspell-lazy 'custom-loads (cons '"flyspell-lazy" loads)) (put 'flyspell 'custom-loads (cons 'flyspell-lazy (get 'flyspell 'custom-loads)))))
...
`Flyspell-Lazy mode' mode.  If the prefix argument is positive, enable
