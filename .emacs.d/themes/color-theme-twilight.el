...
(defun color-theme-twilight ()
  ...
  (color-theme-install
	'(color-theme-twilight
	  ...
	  (mode-line-inactive ((t (:background "grey20" :foreground "black"
                      :box (:color "grey30" :line-width -1 :style nil)))))
          (mode-line ((t (:foreground "grey80" :background "grey30"
                      :box (:color "grey40" :line-width -1 :style nil)))))
