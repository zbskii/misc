...
if __name__ == '__main__':
    ...
    # hack... should probably be sending this as the first arg from emacs
    os.environ['PATH'] += ':/Users/brett/lib:/Library/Frameworks/Python.framework/Versions/Current/bin/'
